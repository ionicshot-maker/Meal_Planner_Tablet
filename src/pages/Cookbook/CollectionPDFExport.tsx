...
export function CollectionPDFExport({ collection, recipes, onClose }: Props) {
...
${options.includeTOC && recipes.length > 1 ? `<h3>Table of Contents</h3><table><thead><tr><th>#</th><th>Recipe</th>${options.includeNutrition ? '<th>Calories</th>' : ''}</tr></thead><tbody>${tocRows}</tbody></table>` : ''}
${recipePages}
</body></html>`
  }
